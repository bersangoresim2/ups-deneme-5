...
def render_intro_menu():
    logo_path = asset_path("ups_logo.png")
...
# -----------------------------
def intro_page():
    video_path = asset_path("intro_video.mp4")
    why_ups_path = asset_path("why_ups.png")
...
def login_page():
    ...
    bg_path = asset_path("login_bg.png")
...
def manager_login_page():
    ...
    bg_path = asset_path("login_devam.png")
...
def about_page():
    ...
    images = [
        asset_path("aboutus1.png"),
        asset_path("aboutus2.jpg"),
        asset_path("aboutus3.png"),
        asset_path("aboutus4.jpg"),
        asset_path("aboutus5.jpg"),
        asset_path("aboutus6.jpg"),
    ]
    ...
    with center:
        ...
        for img in images:
            if img.exists():
                ...
                st.warning(f"Missing image: assets/{img.name}")
